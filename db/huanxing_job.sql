...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (2, 'mall-api', '商城接口', 0, 'http://120.46.176.236:7890/', '2023-01-14 21:55:50');
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (4, 2, '扫描过期的优惠券', '2022-11-02 13:09:17', '2022-11-02 13:10:07', 'lijx', '', 'CRON', '1 * * * * ?', 'DO_NOTHING', 'FIRST', 'upCouponUserStatusJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2022-11-02 13:09:17', '', 1, 1673704561000, 1673704621000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 224079 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
