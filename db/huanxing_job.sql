/*
 ...
 Source Schema         : huanxing_job

 Target Server Type    : MySQL
 Target Server Version : 80024
 File Encoding         : 65001

 Date: 05/01/2023 20:45:55
*/
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (2, 2, '测试定时任务', '2022-06-02 11:16:05', '2022-06-02 11:25:35', 'lijx', '', 'CRON', '0 0/1 * * * ? ', 'DO_NOTHING', 'FIRST', 'testJobHandler', '123', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2022-06-02 11:16:05', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (3, 2, '关闭超时未成团拼团', '2022-10-20 15:45:21', '2022-10-21 10:30:06', 'lijx', 'lijiaxing_boy@163.com', 'CRON', '1 * * * * ?', 'DO_NOTHING', 'FIRST', 'closeOvertimeGroupJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2022-10-20 15:45:21', '', 1, 1672922701000, 1672922761000);
INSERT INTO `xxl_job_info` VALUES (4, 2, '扫描过期的优惠券', '2022-11-02 13:09:17', '2022-11-02 13:10:07', 'lijx', '', 'CRON', '1 * * * * ?', 'DO_NOTHING', 'FIRST', 'upCouponUserStatusJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2022-11-02 13:09:17', '', 1, 1672922701000, 1672922761000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 198063 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `xxl_job_registry` VALUES (102, 'EXECUTOR', 'mall-api', 'http://120.46.176.236:7890/', '2023-01-05 20:45:47');
